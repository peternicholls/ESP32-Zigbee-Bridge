...
static void test_zb_send_onoff_corr_id(void) {
    TEST_START("zb_send_onoff_corr_id");
...
static void test_zb_stack_up_event(void) {
    TEST_START("zb_stack_up_event");
...
void run_zb_adapter_tests(void) {
    zb_init();
    test_zb_send_onoff_corr_id();
    test_zb_stack_up_event();
}
